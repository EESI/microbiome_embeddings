...
dir_out = '/mnt/HA/groups/rosenGrp/embed_cons/out/%s/total_kmers_split/%s' % (name_reads,fn_model_base)
...
total_kmers = r2v.calc_total_kmers_split(path_reads,path_model,k,verbose=True,v=10)
