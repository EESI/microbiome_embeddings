...
dir_split = '/mnt/HA/groups/rosenGrp/embed_samples/data/ag/total_kmers_split'
path_total_kmers = glob(dir_split + '/' + params + '/*total_kmers_split.pkl')

dir_out = '/mnt/HA/groups/rosenGrp/embed_samples/data/ag/total_kmers'
path_out = os.path.join(dir_out,'%s_%s_total_kmers_split.pkl' % (name,params))
